...
import { CommonGetFilters, GetSearchVideosResponse } from 'modules/Common/interfaces';
...
const getVideos =
  (filter: CommonGetFilters) => async (res: NextApiResponse<GetSearchVideosResponse>) => {
    try {
