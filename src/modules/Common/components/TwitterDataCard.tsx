import {
  RiCake2Fill as IconCake,
  RiUserFollowFill as IconFollower,
      ...
      <div className={`${className || ''} ${s.card} ${loading ? s.loading : ''}`} {...props}>
        ...
        <div className={s.infosWrapper}>
          ...
          <ul>
            ...
            {nbFollowers && (
              <li>
                <IconFollower aria-label="Followers" color="#6A6A6A" />
                {humanize(nbFollowers)}
              </li>
            )}
            {verified && (
              <li>
                <svg viewBox="0 0 24 24" aria-label="Verified account" fill="rgb(29, 161, 242)">
                  <g>
